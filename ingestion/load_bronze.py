...
SOURCES = {
    ...
    "AS400_CC_TXN.csv": ("AS400_CC_TXN", ["TXNID", "CRDNO", "CC_CIF", "TXNDT", "TXNAMT", "TXN_CAT", "TXNTYP"]),
    "AS400_DC_TXN.csv": ("AS400_DC_TXN", ["TXNID", "DCRDNO", "DC_CIF", "DC_ACCNO", "TXNDT", "TXNAMT", "TXN_CAT", "TXNTYP"]),
